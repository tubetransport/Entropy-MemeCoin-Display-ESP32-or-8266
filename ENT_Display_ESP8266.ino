...
const char* ssid = "YOUR_SSID"; // Replace the YOUR_SSID with the name of your wifi network
const char* password = "YOUR_Password"; // Replace YOUR-Password with your own wifi network password.
